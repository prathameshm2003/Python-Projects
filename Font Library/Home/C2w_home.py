...
class homeLabel(tk.Frame):
    def __init__(self, parent, main_frame, userData):
        ...
        img_path = os.path.join(script_directory, "../../assests/images/c2w.png")
    ...
    def c2w_show_font_tab(self):
        ...
        if self.font_library_opened:
            ...
            self.c2w_show_label = tk.Label(self.c2w_right_frame, text="Hello from Prathamesh", background="#BCD2E9", font=("Poppins", 50, "bold"), fg=tk_color)
